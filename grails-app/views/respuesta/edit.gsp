...
<html>
	...
	<body>
		<a href="#edit-respuesta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-respuesta" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${respuestaInstance?.version}" />
				<fieldset class="form">
