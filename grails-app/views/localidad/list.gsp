			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nombreLocalidad" title="${message(code: 'localidad.nombreLocalidad.label', default: 'Nombre Localidad')}" />
				...
				<g:each in="${localidadInstanceList}" status="i" var="localidadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${localidadInstance.id}">${fieldValue(bean: localidadInstance, field: "nombreLocalidad")}</g:link></td>
