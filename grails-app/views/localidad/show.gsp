	...
	<body>
		...
		<div id="show-localidad" class="content scaffold-show" role="main">
			...
			<ol class="property-list localidad">
				...
				<g:if test="${localidadInstance?.nombreLocalidad}">
				<li class="fieldcontain">
					<span id="nombreLocalidad-label" class="property-label"><g:message code="localidad.nombreLocalidad.label" default="Nombre Localidad" /></span>
					
						<span class="property-value" aria-labelledby="nombreLocalidad-label"><g:fieldValue bean="${localidadInstance}" field="nombreLocalidad"/></span>
