	...
	<body>
		...
		<div id="show-cordinador" class="content scaffold-show" role="main">
			...
			<ol class="property-list cordinador">
				...
				<g:if test="${cordinadorInstance?.password}">
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="cordinador.password.label" default="Password" /></span>
					
						<span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${cordinadorInstance}" field="password"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${cordinadorInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
