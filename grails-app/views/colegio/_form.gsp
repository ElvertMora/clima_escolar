...
<div class="container">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#home">Datos Colegio</a></li>
        <li><a data-toggle="tab" href="#menu1">Jornadas</a></li>
        <li><a data-toggle="tab" href="#menu2">Datos Sensibilización</a></li>
        ...
        <div id="menu1" class="tab-pane fade">
            <div class="fieldcontain ${hasErrors(bean: colegioInstance, field: 'jornadas', 'error')} ">
                ...
                <ul class="one-to-many">
                    ...
                    <li class="add">
                        <g:link controller="jornada" action="create" params="['colegio.id': colegioInstance?.id]">
                            ${message(code: 'default.add.label', args: [message(code: 'jornada.label', default: 'Jornada')])}
                        </g:link>
                    </li>
                </ul>
            </div>
